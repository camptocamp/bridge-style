...
def _ptToPXMap(values: typing.List[float]) -> typing.List[float]:
    """
    :return: A list of converted pt to px values.
    """
    ptValueToPX = lambda value: pt_to_px(float(value))
    return list(map(ptValueToPX, values))
